<#
    ===========================================================
    Task: Mightora Power Platform Solution XML Node Attribute Updater
...
Write-Host "==========================================================="
Write-Host "Task: Mightora Power Platform Solution XML Node Attribute Updater"
...
$attributeName = Get-VstsInput -Name 'attributeName'
