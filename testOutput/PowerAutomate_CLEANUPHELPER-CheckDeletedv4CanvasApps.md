# Power Automate Flow: CLEANUPHELPER-CheckDeletedv4CanvasApps

**Generated on:** 2025-07-15 19:14:48
**Flow ID:** 000D3A341FFF
**Source File:** CLEANUPHELPER-CheckDeletedv4CanvasApps-D8CDFF83-D68F-EE11-8179-000D3A341FFF.json
...
### Summary
- **Flow Name:** CLEANUPHELPER-CheckDeletedv4CanvasApps
- **Triggers:** 1
- **Actions:** 1 1 1
- **Connections:** 4
- **Parameters:** 1
...
@startuml
!theme plain
title Power Automate Flow: CLEANUPHELPER-CheckDeletedv4CanvasApps
   ...
   if (condition) then (yes)
    :Deleted_Apps (Scope);
     if (condition) then (yes)
      ...
      :DeletedApps (Query);
      :Get_Inventory__Deleted_Apps (Scope);
       if (condition) then (yes)
        :Select_Inventory__Deleted_Apps (Select);
        :Parse_Inventory__Deleted_Apps (ParseJson);
       endif
       partition "Get_Inventory__Deleted_Apps" {
        :Select_Inventory__Deleted_Apps (Select);
        :Parse_Inventory__Deleted_Apps (ParseJson);
       }
      :Get_Actual__Deleted_Apps (Scope);
       if (condition) then (yes)
        :Select_Actual__Deleted_Apps (Select);
        :Parse_Actual__Deleted_Apps (ParseJson);
       endif
       partition "Get_Actual__Deleted_Apps" {
        :Select_Actual__Deleted_Apps (Select);
        :Parse_Actual__Deleted_Apps (ParseJson);
       }
     endif
