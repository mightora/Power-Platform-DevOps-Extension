# Power Automate Flow: CLEANUPHELPER-CheckDeletedv4ModelDrivenApps

**Generated on:** 2025-07-15 19:14:48
**Flow ID:** 000D3A341FFF
**Source File:** CLEANUPHELPER-CheckDeletedv4ModelDrivenApps-5C1D1891-D68F-EE11-8179-000D3A341FFF.json
...
### Summary
- **Flow Name:** CLEANUPHELPER-CheckDeletedv4ModelDrivenApps
- **Triggers:** 1
- **Actions:** 1 1 1
- **Connections:** 3
- **Parameters:** 1
...
@startuml
!theme plain
title Power Automate Flow: CLEANUPHELPER-CheckDeletedv4ModelDrivenApps
 ...
 if (condition) then (yes)
  ...
  :Run_Check_Deleted_Scope (Scope);
   if (condition) then (yes)
    ...
    :Deleted_Apps (Scope);
     if (condition) then (yes)
      :Get_Inventory__Deleted_MDAs (Scope);
       if (condition) then (yes)
        :Select_Inventory__Deleted_MDAs (Select);
        :Parse_Inventory__Deleted_MDAs (ParseJson);
       endif
       partition "Get_Inventory__Deleted_MDAs" {
        :Select_Inventory__Deleted_MDAs (Select);
        :Parse_Inventory__Deleted_MDAs (ParseJson);
       }
      :Get_Actual__Deleted_MDAs (Scope);
       if (condition) then (yes)
        :Select_Actual__Deleted_MDAs (Select);
        :Parse_Actual__Deleted_MDAs (ParseJson);
       endif
       partition "Get_Actual__Deleted_MDAs" {
        :Select_Actual__Deleted_MDAs (Select);
        :Parse_Actual__Deleted_MDAs (ParseJson);
       }
      :DeletedMDAs (Query);
