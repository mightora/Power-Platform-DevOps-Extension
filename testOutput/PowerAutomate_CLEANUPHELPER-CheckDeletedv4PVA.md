# Power Automate Flow: CLEANUPHELPER-CheckDeletedv4PVA

**Generated on:** 2025-07-15 19:14:48
**Flow ID:** 000D3A341D27
**Source File:** CLEANUPHELPER-CheckDeletedv4PVA-7B2C0EE8-7E93-EE11-BE37-000D3A341D27.json
...
### Summary
- **Flow Name:** CLEANUPHELPER-CheckDeletedv4PVA
- **Triggers:** 1
- **Actions:** 1 1 1
- **Connections:** 2
- **Parameters:** 1
...
@startuml
!theme plain
title Power Automate Flow: CLEANUPHELPER-CheckDeletedv4PVA
   ...
   if (condition) then (yes)
    ...
    :Get_Basics (Scope);
     if (condition) then (yes)
      ...
      :List_Inventory_PVAs (OpenApiConnection);
     endif
    ...
    :Deleted_PVAs (Scope);
     if (condition) then (yes)
      :Get_Inventory__Deleted_PVAs (Scope);
       if (condition) then (yes)
        :Select_Inventory__Deleted_PVAs (Select);
        :Parse_Inventory__Deleted_PVAs (ParseJson);
       endif
       partition "Get_Inventory__Deleted_PVAs" {
        :Select_Inventory__Deleted_PVAs (Select);
        :Parse_Inventory__Deleted_PVAs (ParseJson);
       }
      :Get_Actual__Deleted_PVAs (Scope);
       if (condition) then (yes)
        :Select_Actual__Deleted_PVAs (Select);
        :Parse_Actual__Deleted_PVAs (ParseJson);
       endif
       partition "Get_Actual__Deleted_PVAs" {
        :Select_Actual__Deleted_PVAs (Select);
        :Parse_Actual__Deleted_PVAs (ParseJson);
       }
      :DeletedPVAs (Query);
